    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <p className="text-gray-700 mb-4">
          {state.dietPlan.day.substring(0, 80)}...
        </p>
...
const SettingsPage = () => {
  ...
  const handleSave = () => {
    updateSettings({ username, age: parseInt(age), condition });
    setCurrentPage('dashboard');
  };
...
const DietPlanPage = () => {
  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-gray-900">Current Diet Plan</h1>
        <p className="text-gray-600 mt-1">General dietary guidance for your routine</p>
      </div>
      ...
      <div className="space-y-4 mt-6">
        <Card>
          ...
          <p className="text-gray-700">{state.dietPlan.day}</p>
        </Card>

        <Card>
          <h3 className="text-lg font-medium text-gray-900 mb-3">Afternoon</h3>
          <p className="text-gray-700">{state.dietPlan.afternoon}</p>
        </Card>

        <Card>
          <h3 className="text-lg font-medium text-gray-900 mb-3">Night</h3>
          <p className="text-gray-700">{state.dietPlan.night}</p>
        </Card>
        ...
        <Card className="bg-blue-50 border border-blue-100">
          ...
          <ul className="space-y-2 text-gray-700">
            ...
            <li>• Engage in light physical activity as comfortable</li>
            <li>• Maintain consistent meal timings</li>
            <li>• Monitor your response to different foods</li>
          </ul>
        </Card>
      </div>
